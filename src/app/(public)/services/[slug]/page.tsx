            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              <div className="lg:col-span-12">
                <div className="card-neo p-8 animate-pulse space-y-3">
                  <div className="h-8 bg-surface border border-carbon-soft rounded w-1/2" />
                  <div className="h-4 bg-surface border border-carbon-soft rounded w-3/4" />
                  <div className="h-4 bg-surface border border-carbon-soft rounded w-full" />
                </div>
              </div>
            </div>
          ) : (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              <div className="lg:col-span-12 bg-paper-bright border-2 border-carbon-soft p-6 md:p-12 rounded-2xl shadow-[3px_3px_0_var(--color-carbon-soft)]">
                <span className="inline-block bg-volt border-2 border-carbon-soft px-3 py-1 font-mono font-bold uppercase text-[11px] tracking-wide rounded-full mb-4">
              ...
              <div className="lg:col-span-7 h-[300px] md:h-[400px] bg-carbon border-2 border-carbon-soft rounded-2xl relative overflow-hidden grid place-items-center group">
                ...
                <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-2xl bg-volt border-2 border-carbon-soft shadow-[8px_8px_0_var(--color-paper-bright)] grid place-items-center group-hover:rotate-6 group-hover:scale-105 transition-transform duration-300">
                  <Icon size={72} strokeWidth={1.5} className="text-carbon" />
                </div>
                <span className="absolute top-4 left-4 bg-volt border-2 border-carbon-soft px-3 py-1 font-mono font-bold uppercase text-[11px] tracking-wide">
                  {service.category}
                </span>
              </div>

              <div className="lg:col-span-5 flex flex-col gap-6 h-[300px] md:h-[400px]">
                <div className="flex-1 bg-paper-bright border-2 border-carbon-soft p-6 md:p-8 rounded-2xl shadow-[3px_3px_0_var(--color-carbon-soft)] overflow-y-auto">
                  <h2 className="font-display font-extrabold uppercase tracking-tight text-2xl mb-4 pb-4 border-b-2 border-carbon-soft">
                    {t("serviceDetails.overview")}
                  </h2>
                  <p className="text-text-light text-sm leading-relaxed">{service.description}</p>
                </div>
                <div className="bg-volt border-2 border-carbon-soft p-6 rounded-2xl flex flex-col justify-between shadow-[3px_3px_0_var(--color-carbon-soft)]">
              ...
              <div className="lg:col-span-12 bg-paper-bright border-2 border-carbon-soft rounded-2xl overflow-hidden shadow-[3px_3px_0_var(--color-carbon-soft)]">
                <div className="p-6 md:p-8 border-b-2 border-carbon-soft bg-volt">
                ...
                <div className="flex flex-col">
                  {EXPECT.map((e, i) => (
                    <div
                      key={e.num}
                      className={`flex flex-col md:flex-row group hover:bg-mint transition-colors ${i < EXPECT.length - 1 ? "border-b-2 border-carbon-soft" : ""}`}
                    >
                      <div className="p-6 md:p-8 md:w-1/4 border-b-2 md:border-b-0 md:border-r-2 border-carbon-soft flex items-center gap-4">
