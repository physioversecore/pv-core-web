  ...
  return (
    <div>
      <form onSubmit={save} className="card-soft p-6 max-w-2xl space-y-4">
        ...
        <div>
          <label className="text-xs font-medium text-slate">City</label>
        ...
        <div>
          <label className="text-xs font-medium text-slate">Medical history notes</label>
        ...
        <div>
          <label className="text-xs font-medium text-slate">Preferred therapist gender</label>
        ...
        <div>
          <label className="text-xs font-medium text-slate">Notifications</label>
...
function Field({ label, value, onChange }: { label: string; value: string; onChange: (v: string) => void }) {
  return (
    <div>
      ...
      <input value={value} onChange={(e) => onChange(e.target.value)} className="w-full mt-1 px-3 py-2.5 rounded-xl border border-border bg-white focus:outline-none focus:ring-2 focus:ring-pine" />
    </div>
  );
}
