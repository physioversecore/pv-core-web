const en = {
  ...
  find: {
    ...
    placeholderSearch: "Location · name · specialty",
  ...
  availability: {
    ...
    saving: "Saving\u2026",
    openFullMonth: "Open full month",
    openFullMonthDesc: "Bulk-open slots for every matching day in a chosen month.",
    savedPatterns: "SAVED RECURRENCE PATTERNS",
    ...
    willOpen: "This will open",
    slots: "slots",
    across: "across",
    existingBookings: "existing booking(s)",
    leftUntouched: "will be left untouched.",
    pastSkipped: "Past dates were skipped",
    preview: "Preview",
    applying: "Applying\u2026",
    confirmApply: "Confirm & apply",
    workingHours: "WORKING HOURS",
    workingHoursDesc: "Set your daily schedule and slot duration.",
    startTime: "Start time",
    endTime: "End time",
    slotInterval: "Slot interval",
    saveWorkingHours: "Save schedule",
    hoursUpdated: "Working hours saved",
    applyScheduleLabel: "APPLY SCHEDULE",
