const en = {
  ...
  nav: {
    ...
    verification: "Therapist Verification",
    performance: "Therapist Performance",
  ...
  auth: {
    ...
    sendOneTimeCode: "Send one-time code",
    continueWithPassword: "Continue with password",
    enterPassword: "Enter password",
    passwordlessSoon: "Passwordless sign-in is coming soon. Please use your password for now.",
  ...
  about: {
    ...
    statsTitle: "The care we've delivered.",
  ...
  find: {
    ...
    verified: "NMC verified",
    noResultsTitle: "No results found",
    noResultsDesc: "We couldn't find any therapist that matches your search.",
    bannerEyebrow: "Explore testimonials",
    bannerTitle: "Want to learn more?",
    bannerText: "Hear from patients and therapists just like you.",
    bannerCta: "Browse Stories",
    bannerQuote: "My physiotherapist visits twice a week — recovery has never felt this easy.",
  },
  ...
  therapist_dashboard: {
    ...
    coverageHint: "Add your coordinates so patients searching their area can find you by distance.",
    today: "Today",
    ...
    licenseNumberPlaceholder: "e.g. NMC-PT-2018-1234",
    ...
    dayOffRequests: "Your day-off requests",
    noDayOffRequests: "No day-off requests yet",
    rateChangeRequests: "Your rate change requests",
    noRateChangeRequests: "No rate change requests yet",
  ...
  patient_dashboard: {
    ...
    profileImmutableHint: "This is set at signup and can only be changed by an administrator.",
    ...
    profileTabFamily: "Family",
    profileCondition: "Current condition",
    profileConditionPlaceholder: "e.g. Knee pain, post-surgery recovery",
    invalidPhotoType: "Only JPG, PNG, and WebP images are allowed.",
    ...
    familyHint: "Add family members who also need physiotherapy.",
    familyAdd: "Add member",
    familySave: "Save",
    familyCancel: "Cancel",
    familyAdded: "Family member added.",
    familyUpdated: "Family member updated.",
    familyRemoved: "Family member removed.",
    familyAddFailed: "Failed to add family member.",
    familyUpdateFailed: "Failed to update family member.",
    familyRemoveFailed: "Failed to remove family member.",
    familyRequiredError: "Name and relationship are required.",
    relationshipLabel: "Relationship",
    relationshipOptional: "Phone (optional)",
    ...
    settingsConfirmPasswordPlaceholder: "Re-enter the new password",
    ...
    settingsDeleteCancelled: "Deletion cancelled",
    settingsAccountDeleted: "Your account has been deleted. We're sorry to see you go.",
  ...
  adminTeam: {
    title: "Admin Team",
    subtitle: "Super Admins control who else can access this console, and what they can do.",
    ...
    editRole: "Edit role",
    cannotEditOwnRole: "Can't edit your own role",
    deactivate: "Deactivate",
    cannotDeactivateSelf: "Can't deactivate yourself",
    reactivate: "Reactivate",
    superAdmin: "Super Admin",
    supportAdmin: "Support Admin",
    financeAdmin: "Finance Admin",
    deactivatedSuccess: "has been deactivated.",
    reactivatedSuccess: "has been reactivated.",
    inviteModalTitle: "Invite Admin",
    name: "Name",
    ...
    superAdminSummary: "Full access — bookings, payments, complaints, and admin management.",
    supportAdminSummary: "Handles complaints and notifications. No payment or admin-team access.",
    financeAdminSummary: "Manages payments and payouts only.",
    cancel: "Cancel",
    sending: "Sending…",
    ...
    permissionViewPatientsTherapists: "View patients & therapists",
    permissionManageComplaints: "Manage complaints",
    permissionManagePaymentsPayouts: "Manage payments & payouts",
    permissionManageAdmins: "Manage other admins",
  },
