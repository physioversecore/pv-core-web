  ...
  return (
    <div className="space-y-5">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              ...
              className={cn(
                ...
                pointsToUse > 0 ? "bg-[#1F3D2B]" : "bg-gray-300"
              )}
            >
              <span
                className={cn(
      ...
      <div className="bg-[#F0F0EE] rounded-xl p-4 space-y-2">
        ...
        {pointsDiscount > 0 && (
          <div className="flex justify-between text-sm">
            <span className="text-gray-500">Points ({pointsToUse.toLocaleString()})</span>
        ...
        <div className="flex justify-between text-sm font-bold border-t border-gray-300 pt-2">
          ...
          <span className="text-[#1E2A2E]">{symbol}{(total - pointsDiscount).toFixed(2)}</span>
        </div>
        {pointsDiscount > 0 && (
