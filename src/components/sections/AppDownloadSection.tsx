        ...
        <Reveal>
          ...
          <ul className="space-y-4 mb-8 text-paper-bright/85">
            <li className="flex items-center gap-3">
              <span className="w-10 h-10 grid place-items-center rounded-xl bg-volt text-carbon border-2 border-carbon-soft"><FileText size={18} /></span>
              {t("app.feature1")}
            </li>
            <li className="flex items-center gap-3">
              <span className="w-10 h-10 grid place-items-center rounded-xl bg-mint text-carbon border-2 border-carbon-soft"><MessageCircle size={18} /></span>
              {t("app.feature2")}
            </li>
            <li className="flex items-center gap-3">
              <span className="w-10 h-10 grid place-items-center rounded-xl bg-paper-bright text-carbon border-2 border-carbon-soft"><Bell size={18} /></span>
              {t("app.feature3")}
            </li>
          </ul>
          ...
          <div className="relative mx-auto w-[280px] h-[560px] rounded-[2.5rem] bg-carbon border-2 border-paper-bright shadow-[8px_8px_0_var(--color-volt)] phone-float">
            ...
            <div className="absolute inset-2 rounded-[2rem] bg-paper text-carbon p-4 flex flex-col gap-3 overflow-hidden">
              ...
              <div className="card-neo p-3 chat-float" style={{ animationDelay: "0.6s" }}>
                ...
                <div className="mt-2 h-1.5 rounded-full bg-surface overflow-hidden border border-carbon-soft">
                  <div className="h-full bg-moss progress-fill" />
                </div>
                <div className="text-[10px] text-text-light mt-1">Session 6 of 10</div>
              </div>
              <div className="rounded-xl bg-moss text-white p-3 chat-float border-2 border-carbon-soft shadow-[1px_1px_0_var(--color-carbon-soft)]" style={{ animationDelay: "1.2s" }}>
              ...
              <div className="rounded-xl bg-paper-bright p-2 flex items-center gap-2 chat-float border-2 border-carbon-soft shadow-[1px_1px_0_var(--color-carbon-soft)]">
                <div className="w-7 h-7 rounded-full bg-volt grid place-items-center text-[10px] text-carbon font-bold border-2 border-carbon-soft">AS</div>
