    ...
    <section id="top" className="relative min-h-screen overflow-hidden bg-moss text-white grid-bg">
      ...
      <div className="relative max-w-7xl mx-auto px-5 lg:px-8 pt-36 md:pt-44 pb-20 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        <Reveal className="md:col-span-5 lg:col-span-6">
          ...
          <h1
            className="font-display font-extrabold uppercase leading-[0.85] tracking-tighter mb-6"
            style={{ fontSize: "clamp(2.6rem, 6vw, 5.5rem)" }}
          >
            {t("landing.heroTitle")}
          </h1>
          <p className="text-white/80 text-lg max-w-xl mb-8">{t("landing.heroDesc")}</p>
          <div className="flex flex-wrap gap-4 mb-8">
            <Link
              href="/services"
              className="mt-1 inline-flex items-center gap-1 btn-volt uppercase"
            >
        ...
        <Reveal delay={120} className="md:col-span-7 lg:col-span-6">
          <HeroFindTherapist
            q={q}
            city={city}
            spec={spec}
