...
export function PatientSelectStep({ patients, selectedPatientId, onSelect, onContinue }: Props) {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h2 className="text-xl font-bold text-text">Select patient</h2>
                ...
                results.map((p) => (
                  <button
                    ...
                    className={cn(
                      ...
                      p.id === selectedPatientId && "bg-secondary/5",
                    )}
                  >
      ...
      {selected && (
        <div className="bg-surface rounded-xl p-4 space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium text-text">{selected.email}</span>
          </div>
        </div>
      )}
