...
export function TherapistSelectStep({
  ...
  return (
    <div className="space-y-5">
      <div>
        <h2 className="text-xl font-bold text-text">Select therapist</h2>
            ...
            <div className="p-2 border-b border-gray-100">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-9 py-2 rounded-lg border border-gray-200 bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-secondary/20 focus:border-secondary"
                />
                {isFetching && (
                ...
                results.map((t) => (
                  <button
                    ...
                    className={cn(
                      ...
                      t.id === selectedTherapistId && "bg-secondary/5",
                    )}
                  >
      ...
      {selected && (
        <div className="bg-surface rounded-xl p-4 space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium text-text">{selected.specialty}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-500">Rate</span>
            <span className="font-medium text-text">Rs. {selected.price.toLocaleString("en-IN")} / session</span>
          </div>
        </div>
      )}
